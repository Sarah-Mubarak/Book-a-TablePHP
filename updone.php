...
<br><br>
<a href="addpe.php"><button class="buttt2">  اضافة عطر</button></a>
<br><br>
<a href="delete.php"><button class="buttt3" >  حذف عطر</button></a>
<br><br>
<a href="up.php"><button class="buttt4">  تعديل عطر</button></a>
<br><br>
<a href="selectper.php"><button class="buttt5"> عرض العطور</button></a>
<br><br>
...
<p id="perinfo">"تم تعديل المطعم بنجاح"</p>
