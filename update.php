...
?>
  <center>
    <h1 class="perinfo">      تعديل المطاعم    </h1><br><br><br><br>
...
<label for="file" class="prof-addpe">تعديل صورة المطعم </label>
    <br>
    <input type="text" name='id' class="name1" value="<?php echo $row['id']   ?>"  >
    <br>
    <input type="text" name='name' class="name1" value="<?php echo $row['name']   ?>">
    <br>
<button id="save" type="submit" name='update'>تعديل</button>
</center>
</section>
